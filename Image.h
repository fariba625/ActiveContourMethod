 ...
 * date:    July 20, 2003
 * description: 
 *			The main class used to do the image maniplutation. 
 *			Leve set Methods are used. 
 *			Image is an m by n Image matrix, where m is number of rows 
 *			(height), n is number of columns (width).
 *      
 ******************************************************************/ 
#include "cv.h"
#include "highgui.h"
